		...
		<div class="flex gap-4 justify-center">
			...
			>
				<UIcon
					...
					class="size-5"
				/>
				<h3 class="text-xl sm:text-2xl font-semibold">{{ withSuffix(user.mutual_count ?? 0) }}</h3>
			...
			>
				<UIcon
					...
					class="size-5"
				/>
				<h3 class="text-xl sm:text-2xl font-semibold">{{ withSuffix(user.added_count ?? 0) }}</h3>
			...
			>
				...
				<h3 class="text-xl sm:text-2xl font-semibold">
					{{ withSuffix(user.non_mutual_count ?? 0) }}
				</h3>

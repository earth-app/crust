<template>
	<div class="text-left">
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			and any related services (collectively, the "services"). By accessing or using our services,
			you agree to the practices described in this Privacy Policy. This Privacy Policy should be
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			number, physical address, country, biography, profile photo, and the interests and activities
			you select. We also collect the content you submit, such as prompts, prompt responses,
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			usage data about how you interact with our services. We use cookies, local storage, and
			similar technologies (described in Section 4) to operate the services, and we use Cloudflare
			Turnstile during sign-up, log-in, and other sensitive actions to help distinguish humans from
			automated abuse; Turnstile may process device and browser signals and your IP address for that
			purpose. We retain a record of the IP addresses you log in from to help secure your account
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			diagnostic logs on your device to help you troubleshoot problems; these logs are sanitized to
			remove credentials, remain on your device, and are not transmitted to us unless you choose to
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			you; to maintain the security and integrity of our services (including verifying new sign-ins,
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			of them while you maintain an account. <strong>Marketing and promotional messages</strong> are
			optional, and you may opt out at any time by using the unsubscribe link in those messages or
			by adjusting your notification preferences.
			<strong
				>We do not sell, rent, or trade your personal information, and we do not use your personal
				information for third-party advertising.</strong
			>
		</p>
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			activities) to AI models operated through our infrastructure provider's AI platform
			(Cloudflare Workers AI). We also use AI to generate and rank general, non-personalized content
			such as articles, prompts, and quizzes. AI-generated output may be inaccurate or incomplete
			and should not be relied upon for important decisions. We do not use these AI features to make
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			link, a cookie that records the referral code. We also use local storage on your device to
			remember preferences and interface state (for example, completed tours, widget data, and a
			queue of actions to retry when you are offline). We do not use third-party advertising or
			cross-site tracking cookies. You can control or clear cookies and local storage through your
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			processing, Turnstile bot protection, and aggregate request analytics); Google, including
			Firebase Cloud Messaging for push notifications, Google Fonts, the Google Maps Platform for
			converting addresses and coordinates into place information, and Google sign-in; Microsoft,
			Apple, GitHub, and Discord for third-party sign-in; and Unsplash, Pixabay, YouTube, Wikipedia,
			and the Internet Archive for retrieving media and reference content that you search for or
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			fields — such as your country, address, and phone number — can be set to "Public," "Mutual,"
			"Circle," or "Private," which controls who can see that information. Some information, such as
			leaderboard standings, badges, cosmetics, and journey streaks, may appear publicly when your
			settings allow it. We honor these settings, but please remember that anything you make public
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			generated badge-mastery quests for about 90 days; email and verification tokens for about 30
			days; and pending content reports expire automatically after about 7 days if no action is
			taken. Certain user content is also removed automatically over time — for example, prompts
			after roughly 2 days, articles after roughly 14 days, and events roughly 30 days after they
			end. When content is removed by moderation, we keep a temporary record for about 30 days (as
			described in our Terms of Service) before permanent deletion. These periods are approximate
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			stored content, such as event image submissions. However, no method of transmission over the
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			and processed in the United States and other countries that may not have the same data
		...
		<p class="text-md mt-2 max-w-3xl">
			<strong
				...
				jurisdiction</strong
			>, you have the right to access, correct, delete, restrict, or object to our processing of
			your personal information, the right to data portability, and the right to withdraw consent
			where processing is based on consent. We process personal information on the legal bases of
			performing our contract with you (to provide the services), our legitimate interests (such as
			securing and improving our services), your consent (for example, for device permissions and
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			"sharing" of personal information. We do not sell or share your personal information as those
		...
		<p class="text-md mt-2 max-w-3xl">
			...
			other applicable laws, we do not knowingly collect personal information from children under
			the applicable age. If we learn that we have collected personal information from a child under
			that age without appropriate consent, we will delete it as soon as possible. If you are a
